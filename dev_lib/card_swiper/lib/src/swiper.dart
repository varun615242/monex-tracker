...
class ScaleAndFadeTransformer extends PageTransformer {
  ...
  Widget transform(Widget child, TransformInfo info) {
    ...
    var c = child;
    if (_scale != null) {
      final double safeScale = _scale ?? 1.0;
final scaleFactor = (1 - position!.abs()) * (1 - safeScale);
final scale = safeScale + scaleFactor;

final double safeFade = _fade ?? 1.0;
final fadeFactor = (1 - position!.abs()) * (1 - safeFade);
final opacity = safeFade + fadeFactor;
